...
SELECT *
  ...
  (SELECT 
    ...
    CASE 
        WHEN E.TYPE_DETAIL_PRICING IN ('1-Blacklist') THEN '1-Blacklist'
        WHEN E.TYPE_DETAIL_PRICING IN ('2-Manual Strategy') THEN '2-Manual'
        WHEN E.TYPE_DETAIL_PRICING IN ('3-Tier wo/CCogs') THEN '3-Tier wo/CCogs'
        WHEN E.TYPE_DETAIL_PRICING IN ('4-DoD & Lightning wo/CCogs') THEN '4-DoD & Flash wo/CCogs'
        WHEN E.TYPE_DETAIL_PRICING IN ('5-Tier w/CCogs', '6-DoD & Lightning w/CCogs', '7-Automatic Strategies') THEN 'Automatic' 
        ELSE 'REVIEW' 
    END AS TYPE_PRICING,
    CASE 
        WHEN E.TYPE_DETAIL_PRICING IN ('1-Blacklist', '2-Manual Strategy', '3-Tier wo/CCogs', '4-DoD & Lightning wo/CCogs') THEN 'Manual Pricing'
        WHEN E.TYPE_DETAIL_PRICING IN ('5-Tier w/CCogs', '6-DoD & Lightning w/CCogs', '7-Automatic Strategies') THEN 'Automatic Pricing' 
        ELSE 'REVIEW' 
    END AS TYPE_PRICING_AUTOMATIC_MANUAL,
    SUM(
        CASE 
            WHEN E.TYPE_DETAIL_PRICING IN ('5-Tier w/CCogs', '6-DoD & Lightning w/CCogs', '7-Automatic Strategies') 
            THEN E.PL1P_TIME_IN_STATUS_PERC * V.VISITS_TOTALES 
            ELSE 0 
        END
    ) AS VISITS_AUTOMATICL_PRICE,
