SELECT P.TIM_DAY,
        ...
        SUM(COALESCE(VISITS_1IF,0)) AS VISITS_1IF,
        SUM(COALESCE(VISITS_2IF,0)) AS VISITS_2IF,
        SUM(COALESCE(VISITS_3IF,0)) AS VISITS_3IF,
        SUM(COALESCE(TOTAL_VISITS_PRODUCTS,0)) AS VISITAS_TOTALES,
