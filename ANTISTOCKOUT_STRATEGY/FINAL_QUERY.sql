...
SELECT E.*
    ...
    ,SUM(COALESCE(I.INB_QUANTITY,0) - COALESCE(F.ORDERS_FORECAST,0)) OVER (PARTITION BY E.SIT_SITE_ID, E.ITE_ITEM_ID ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT_ROW ORDER BY E.TIM_DAY) AS DELTA_STOCK_ACCUM
    ,E.ITE_ITEM_QUANTITY_AVAILABLE - SUM(COALESCE(I.INB_QUANTITY,0) - COALESCE(F.ORDERS_FORECAST,0)) OVER (PARTITION BY E.SIT_SITE_ID, E.ITE_ITEM_ID ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT_ROW ORDER BY E.TIM_DAY) AS STOCK_FORECAST
FROM ESQUELETO E 
