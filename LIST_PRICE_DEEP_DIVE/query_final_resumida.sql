WITH RAW_DATA AS (
  ...
  FROM `meli-bi-data.SBOX_PRICING1P.LIST_PRICE_VALIDATION_INPUTS` 
  -- WHERE 1=1
...
, REDUNDANT_OFFERINGS AS (
  SELECT ITEM_ID
      ,CASE WHEN N_ACTIVE_OFFERINGS_SKU > 1 THEN 1 ELSE 0 END AS FLAG_SKU_MULTIPLE_ACTIVE_OFFERINGS
    FROM (
    SELECT ITEM_ID,
      PL1P_OFFE_SAP_SKU,
