...
SELECT 
  ...
  ,MIN( CASE WHEN FLAG_SKIP_VALIDATION = 0 THEN 1.05 * PL1P_OFFE_UNIT_PRICE_AMOUNT ELSE NULL END)  AS COST_LOWER_BOUND
  ,MIN( CASE WHEN FLAG_SKIP_VALIDATION = 1 THEN 0 ELSE FLAG_ABOVE_COST_UPPER_BOUND END) AS FLAG_ABOVE_COST_UPPER_BOUND
  ,MAX( CASE WHEN FLAG_SKIP_VALIDATION = 0 THEN 5 * PL1P_OFFE_UNIT_PRICE_AMOUNT ELSE NULL END)  AS COST_UPPER_BOUND
