...
LEFT JOIN WHOWNER.LK_ITE_ITEMS IT ON OFF.SIT_SITE_ID = IT.SIT_SITE_ID AND OFF.ITE_ITEM_ID = IT.ITE_ITEM_ID , UNNEST(ITE_ITEM_ATTRIBUTES) K
WHERE K.ID = 'BRAND'