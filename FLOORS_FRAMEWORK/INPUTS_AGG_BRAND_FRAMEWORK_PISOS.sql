...
LEFT JOIN SBOX_PRICING1P.TARGETS_BPC_BOX_AB_2025 T ON U.SIT_SITE_ID = T.SITE AND U.VERTICAL = T.VERTICAL AND T.MONTH = EXTRACT(YEAR FROM CURRENT_DATE)*100 + EXTRACT(MONTH FROM CURRENT_DATE)
